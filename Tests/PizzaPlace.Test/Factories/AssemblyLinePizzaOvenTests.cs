...
public class AssemblyLinePizzaOvenTests
{
    ...
    public async Task PreparePizzas_OnePizza()
    {
        ...
        var expectedTime = PizzaOvenHelperTests.StandardPizzaPrepareTime + AssemblyLinePizzaOven.SetupTimeMinutes;
    ...
    public async Task PreparePizzas_23_OfTheSameTypePizza()
    {
        ...
        [
            new PizzaPrepareOrder(PizzaOvenHelperTests.GetTestTastyPizzaRecipe(), 23),
         ];
        var stock = PizzaOvenHelperTests.GetPlentyStock();

        var oven = GetOven(timeProvider);
        // PizzaOvenHelperTests.TastyPizzaPrepareTime + AssemblyLinePizzaOven.SetupTimeMinutes = 22
    ...
    public async Task PreparePizzas_MixedPizzaTypes()
    {
        ...
        ComparableList<PizzaPrepareOrder> order =
        [
            new PizzaPrepareOrder(PizzaOvenHelperTests.GetTestTastyPizzaRecipe(), 10),
             new PizzaPrepareOrder(PizzaOvenHelperTests.GetTestStandardPizzaRecipe(), 7),
         ];
        var stock = PizzaOvenHelperTests.GetPlentyStock();
