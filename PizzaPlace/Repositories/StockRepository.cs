...
public class StockRepository : IStockRepository
{
    ...
    public Task<StockDto> GetStockDto(StockType stockType) => throw new NotImplementedException("A real repository must be implemented.");
    ...
    {
        return new ComparableList<StockDto>();
    }
